# UD1 — Introducción a la programación. Lenguaje Java (Beta)
...
- **public class HolaMundo**: En Java, todo debe vivir dentro de una clase.
- **public static void main(String[] args)**: Este método es el equivalente exacto al **if __name__ == "__main__"**: de Python. Es el único lugar donde el ordenador comienza a ejecutar el programa.
- **System.out.println**: El comando para imprimir en consola con salto de línea.
...
!!! danger "Los errores lógicos son los más peligrosos para los desarrolladores"
...
!!! danger "Los errores de ejecución son los que dan mas quebraderos de cabeza a los administradores de sistemas"
    Los errores de ejecución pueden tumbar el sistema y pueden ocurrir de manera imprevisible, por lo que obliga a estar atentos para volver a arrancar los sistemas.
...
Una constante es igual que una variable, salvo que su valor **no puede cambiar, o no se debería** una vez asignado.
...
Estos operadores son idénticos en Java y Python
...
> **Escribe y ejecuta** este programa en https://www.onlinegdb.com/ antes de continuar.
...
Analicemos el código de java:

| Bloque | Descripción | Utilidad |
|---|---|---|
| **Importaciones** | `import ...` | Trae herramientas externas (como `Random`) que no vienen cargadas por defecto. |
| **Clase** | `public class ...` | Es el contenedor global. Todo el código en Java debe vivir dentro de una clase. |
| **Método Main** | `public static void main...` | Es el "punto de entrada". El ordenador empieza a ejecutar el programa exactamente aquí. |
| **Instrucciones** | El cuerpo del código | Son las órdenes secuenciales que el programa ejecuta una a una. |
...
Los operadores de incremento y decremento no existen en Python.
...
**Métodos de lectura disponibles de Scanner:**
